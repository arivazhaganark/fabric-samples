...
##set chaincode path
CC_SRC_PATH="$PWD/artifacts/src/github.com/fabwallet_cc/node"
...
echo
curl -s -X GET \
  "http://localhost:4000/channels/mychannel/chaincodes/mycc?peer=peer0.org1.example.com&fcn=query&args=%5B%22WALLET0%22%5D" \
  -H "authorization: Bearer $ORG1_TOKEN" \
  -H "content-type: application/json"
echo
echo
